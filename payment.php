<section class="payment">
    <div>Оплата заказа возможна <br><a href="oplata.php">наличными в офисах нашего центра</a>, другие варианты:</div>
    <!--
    ...
    <div><a href="oplata.php"><img class="desaturated" src="<?php echo $img_path_1; ?>" width="122" height="37" alt=""></a></div> <!-- width="122" height="37" -->

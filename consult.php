...
?>
			...
			<div class="responses">	<div class="one">
		<div class="left"><img src="./consult_files/user.png" width="32" height="32" alt=""></div>
		<div class="rite">
			<span></span>
			<div>
				<div class="caption"><b>Елена (ИТМО)</b> <i>17 ноября</i></div>
	...
	<div class="one">
		...
		<div class="rite">
			<span></span>
			<div>
				<div class="caption"><b>Вика (СПБГЭУ)</b> <i>2 ноября</i></div>
	...
	<div class="one">
		...
		<div class="rite">
			<span></span>
			<div>
				<div class="caption"><b>Анастасия (университет Лесгафта)</b> <i>30 октября</i></div>
	...
	<div class="one">
		...
		<div class="rite">
			<span></span>
			<div>
				<div class="caption"><b>Кирилл  (СПбГЭУ)</b> <i>24 октября</i></div>
	...
	<div class="one">
		...
		<div class="rite">
			<span></span>
			<div>
				<div class="caption"><b>Катя (Колледж)</b> <i>7 октября</i></div>
	...
	<div class="one">
		...
		<div class="rite">
			<span></span>
			<div>
				<div class="caption"><b>Инна (Герцена)</b> <i>25 сентября</i></div>
	...
	<div class="one">
		...
		<div class="rite">
			<span></span>
			<div>
				<div class="caption"><b>Игорь</b> <i>12 сентября</i></div>
	...
	<div class="one">
		...
		<div class="rite">
			<span></span>
			<div>
				<div class="caption"><b>Ангелина (СПбГАУ)</b> <i>18 августа</i></div>
...
<br>Кроме того, сделано качественно и с умом. Видно, что работали профессионалы своего дела. Помогли и с речью, и с презентацией для защиты. Не пожалела, что обратилась, тем более не такие высокие цены, как на многих других сайтах.  Большое спасибо! Диплом на 5! Посоветую всем знакомым.</div>
	...
	<div class="one">
		...
		<div class="rite">
			<span></span>
			<div>
				<div class="caption"><b>Алексей</b> <i>9 июля</i></div>
	...
	<div class="one">
		...
		<div class="rite">
			<span></span>
			<div>
				<div class="caption"><b>Тарас (МБИ)</b> <i>27 мая</i></div>

	...
	<div class="one">
		...
		<div class="rite">
			...
			<div>
				...
				<div class="text">Очень долго искала по просторам интернета кто бы помог мне сделать дипломную работу на выгодных условиях. И вот чисто случайно попала на этот сайт, где Учебный центр ''<?php echo $site_name; ?>'' в максимально короткие сроки помогла справиться мне с этой проблемой. Я получила качественно выполненную дипломную работу, благодаря которой я закончила учёбу на отлично.</div>
			</div>
		</div>
	</div>
	<div class="one">

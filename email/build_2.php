      ...
      <table border="0" width="600" cellpadding="0" cellspacing="0" class="container" style="width:600px;max-width:600px">
        <tr>
          ...
          <span style="color: green;">Здравствуйте, '.$name.'! '.$vid_rab.' за '.$pay.'!</span><br>
            Срочное выполнение работ, низкие цены!
              ...
              <tr>
                <td class="content-wrapper" style="padding-left:24px;padding-right:24px">
                  ...
                  Компания "<a href="'.$site_url.'">'.$site_name.'</a>"
                    ...
                    актуальность работы, ее практическое значение, подберет список литературы.<br>
        ...
        <tr>
          <td class="container-padding footer-text" align="left" style="font-family:Helvetica, Arial, sans-serif;font-size:12px;line-height:16px;color:#aaaaaa;padding-left:24px;padding-right:24px">
            ...
            Наша команда профессиональных авторов – исполнителей, преподавателей профильных ВУЗов Москвы, Санкт-Петербурга и других регионов помогут вам выполнить дипломную работу по теме, которая будет неповторима, уникальна и обязательно без плагиата. У Вас высвободиться свободное время, Вы спокойно подготовитесь к защите своей дипломной работы, а мы Вам в этом поможем, приложив все свои умения, знания и опыт. А недорогая стоимость Вас приятно удивит!

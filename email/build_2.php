...
<a href="https://vk.com/club11424604" alt="Мы в контакте">Мы в контакте</a>, всегда на связи с ВУЗами России и стран СНГ.';
        break;
    case 12:
        $text_kurs = 'Предоставляем гарантию 2 месяца на все работы. Работаем по указанию Заказчика.
        <a href="https://vk.com/club11424604" alt="Мы в контакте">Мы в контакте</a>, в связке с ВУЗами Российской Федерации.';
        break;
    case 13:
        $text_kurs = 'Мы выполняем курсовые работы по методическим указаниям Заказчика, даем гарантии.
        <a href="https://vk.com/club11424604" alt="Мы в контакте">Мы в контакте</a>, сотрудничаем с университетами России.';
        break;
...
';
    ...
    case 11:
        ...
        <a href="https://vk.com/club17204104" alt="Помощь детям">Помощь детям</a>, 2% оплаты отправляем больным.';
        break;
    case 12:
        $text_dip = 'Исправим бесплатно работу. Ознакомим с примерами дипломных работ без предоплаты.
        <a href="https://vk.com/club17204104" alt="Благотворительная акция">Благотворительная акция</a>, 3% оплаты детям.';
        break;
    case 13:
        $text_dip = 'Мы доводим дипломные до успешной сдачи. Предоставляем примеры дипломов авторов.
        <a href="https://vk.com/club17204104" alt="Поддержка детей">Поддержка детей</a>, 4% отправляем малышам.';
        break;
...
switch ($text_mag_case) {
    ...
    case 11:
        ...
        Новости о нас: мы известны как <a href="http://newsmiass.ru/index.php?news=21684" alt="Помощь детям">университетский сайт</a>.';
        break;
    case 12:
        $text_mag = 'Этапы выполнения в личном кабинете! Предоставим реквизиты центра "База знаний"!
         Мы являемся негласным <a href="http://newsmiass.ru/index.php?news=21684" alt="Помощь детям">университетским сайтом</a>.';
        break;
    case 13:
        $text_mag = 'Мы открываем удобный личный кабинет, чтобы следить за этапами выполнения магистерской.
        Иногда нас называют <a href="http://newsmiass.ru/index.php?news=21684" alt="Помощь детям">университетским сайтом</a>.';
        break;
                      ...
                      <td class="coo'.$style_1.'332l"  style="padding-left:10px;padding-right:10px;padding-top:16px;padding-bottom:10px">
                        ...
                        <table class="im3g'.$style_1.'wrap25per">
                          <tr>
                            ...
                            <td style="padding-bottom:16px"><img alt="Дипломная" src="'.$kart_2.'" border="0" width="164" height="112" style="max-width:99%; " ></td>
                          </tr>

...
<h4>Наша компания предлагает выполнение дипломов, в том числе срочных. Цены дипломных работ при срочном выполнении
    ...
    Однако при полной предоплате вы получите скидку 20%. Эта акция действует для всех новых клиентов.<br></h4>
<style>

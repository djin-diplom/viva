...
if ( (int)$i >= (int)$count) {
    ...
    switch ($sub_2) {
        case 1:
            $sub_2_text = ' Выполнение без предоплаты';//' Нет аванса';
            break;
        case 2:
            $sub_2_text = ' Пришлем примеры работ';//' Без аванса';
            break;
        case 3:
        ...
        case 4:
            ...
            break;
        case 5:
            $sub_2_text = ' Примеры для ознакомления';//' Никаких предоплат';
            break;
        case 6:
            $sub_2_text = ' Предлагаем часть без аванса';
            break;
        case 7:

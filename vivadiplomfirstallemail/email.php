...
<table style="text-align:center;word-wrap:break-word;line-height:1.786;font-size:14px;width:630px;border-spacing:0px">
	...
	<tr>
		<td style="padding:0px">
			<table style="width:100%;height:317px;text-align:center;border-collapse:separate;background:url(<?php echo $path_img; ?>index_files/unnamed.png);line-height:normal">
				<tbody><tr>
					<td style="width:50%">

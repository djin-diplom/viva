	...
	<tr>
		...
		<tr>
			<td>
				...
				Завтра мы вышлем БЕЗ ПРЕДОПЛАТЫ пример (часть) работы Вашего автора по предмету.<br>
				После  этого для продолжения выполнения работы следует внести предоплату 50%<br>
				или оплатить полную стоимость, чтобы получить скидку 20%.<br>
				Мы будем выполнять работу по Вашим указаниям и Вашему плану.<br>

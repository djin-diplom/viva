...
<table style="text-align:center;word-wrap:break-word;line-height:1.786;font-size:14px;width:630px;border-spacing:0px">
	...
	<tr>
		<td style="padding:0px">
			<table style="width:100%;height:317px;text-align:center;border-collapse:separate;background:url(&#39;https://ci3.googleusercontent.com/proxy/YHFJO7OmhsLT0PQOAkV_n4YntiGbjqMjaWruAu6e9Wf6wgvHAsHYbKHpS2tYa_77BhBub6436uzNPaJtsJgl-vKKY26QGO1qKZvndp-LLwJEv7j9HJIaSO_UnsgABq_Qhp1P0ZYRioHPEnoKlPU=s0-d-e1-ft#https://www.homework.ru/customer/content/emails/OrderEstimatedCustomerEmail/table-bg.png&#39;) no-repeat;line-height:normal">
				<tbody><tr>
					<td style="width:50%">
...
<table style="text-align:center;font-size:14px;padding:0 30px;width:100%">
	...
	<table style="width:630px;border-spacing:0;font-size:14px;margin:auto" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td style="color:#98a4ab;text-align:center;padding-bottom:10px;padding-top:25px">
				Если вы хотите отписать от рассылки, перейдите сюда
				<a href="<?php echo $site_url; ?>otpiska.php" class="m_3689207491995373867gp-button" target="_blank" ">
			</td>
		<tr>
		</tr>

	...
	<tr>
		...
		<tr>
			<td>
				...
				Завтра мы вышлем Вам БЕЗ ПРЕДОПЛАТЫ часть работы.<br>
				Далее для продолжения выполнения работы следует внести предоплату 50%<br>
				(или оплатить полную стоимость, чтобы получить скидку 20%).<br>
				...
				Для получения всей работы требуется оплатить заказ.<br> Это можно сделать через платежные системы.<br>
